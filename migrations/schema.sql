...
ALTER SEQUENCE public.room_restriction_id_seq OWNER TO postgres;
...
--
-- Name: room_restriction_reservations_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX room_restriction_reservations_id_idx ON public.room_restriction USING btree (reservations_id);
...
ALTER TABLE ONLY public.room_restriction
    ADD CONSTRAINT room_restriction_reservations_id_fk FOREIGN KEY (reservations_id) REFERENCES public.reservations(id) ON UPDATE CASCADE ON DELETE CASCADE;
